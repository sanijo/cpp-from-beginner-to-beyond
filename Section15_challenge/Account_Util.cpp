...
// Withdrew supplied amount from each Account object in the vector
// with overloaded operator -=
...
// Deposits supplied amount to each Savings Account object in the vector +=
void deposit_overloaded(std::vector<Savings_Account> &accounts, double amount) {
    std::cout << "\n=== Depositing to Savings Accounts += ==========================" << std::endl;
    for (auto &acc:accounts)  {
        if (acc += amount) 
            std::cout << "Deposited " << amount << " to " << acc << std::endl;
...
// Withdraw supplied amount from each Savings Account object in the vector -=
void withdraw_overloaded(std::vector<Savings_Account> &accounts, double amount) {
    std::cout << "\n=== Withdrawing from Savings Accounts -= ======================" << std::endl;
    for (auto &acc:accounts)  {
        if (acc -= amount) 
            std::cout << "Withdrew " << amount << " from " << acc << std::endl;
